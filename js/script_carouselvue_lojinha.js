...
const app = new Vue({
  ...
  data: function () {
    return {
      imgs_artigos: [
        './img/artigos_lojinha/1.png',
        './img/artigos_lojinha/2.png',
        './img/artigos_lojinha/3.png',
        './img/artigos_lojinha/4.png',
        './img/artigos_lojinha/5.png',
        './img/artigos_lojinha/6.png',
